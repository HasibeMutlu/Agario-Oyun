...
public class FirstPanel extends JPanel {
	...
	public FirstPanel() {
		...
		//hic bir sey secmeden baslarsak easy olarak baslar
		...
		add(rdbtnHard);
		//ayni anda birden fazla button secmememk icin kullandik
		...
		btnAbout.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				JOptionPane.showConfirmDialog(FirstPanel.this,"AGARIO oyunu\n Eclipse ortaminda JAVA dili kullanilarak"
						+ "\n Hasibe ve Intizar\t"+
						"\t tarafindan gelistirilmistir","Hakkinda", JOptionPane.DEFAULT_OPTION);
			}
		});
